...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT username, phash, usertype, fname, lname, state FROM people WHERE username = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $username, $hashed_password, $role, $fname, $lname, $state);
...
<head>
	<meta char="UTF-8">
	<title> TeamCDA Website - Log in </title>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="bottom-padding form-group">
                ...
                <input type="submit" class="btn btn-primary float-right ml-2" value="Login">
            </div>
        </form>
    </div>    
</body>
