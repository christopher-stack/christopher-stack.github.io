...
function () {
  ...
  g.prepareElement = function (b, c, d) {
    ...
    if (g.useCss) {
      ...
      b.innerHTML = '<img style="' + c + '" src="../images/pacman10-hp-sprite-2.png">'
    }
  };
  ...
  g.createKillScreenElement = function (b, c, d, f, h) {
    ...
    j.style.zIndex = 119;
    if (h) {
      j.style.background = "url(../images/pacman10-hp-sprite-2.png) -" + g.killScreenTileX + "px -" + g.killScreenTileY + "px no-repeat";
      g.killScreenTileY += 8
  ...
  g.prepareGraphics = function () {
    g.graphicsReady = e;
    g.preloadImage("../images/pacman10-hp-sprite-2.png")
  };
